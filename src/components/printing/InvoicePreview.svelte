...
<div>
  ...
  {:else if company}
    ...
    <div
      ...
      class="invoice-container bg-white text-black p-8 font-sans print:p-4 max-w-[210mm] mx-auto"
    >
      ...
      >
        ...
        <div class="p-3 border-r border-black">
          ...
          {#if partyAccount}
            <div class="font-semibold text-base mb-1">{partyAccount.name}</div>
          ...
          <tbody>
            {#each itemLines as line, i}
              <tr class="border-b border-gray-300">
                <td class="p-2 border-r border-gray-300 text-center">{i + 1}</td
                >
            ...
            {#each Array(Math.max(0, 5 - itemLines.length)) as _, i}
              <tr class="border-b border-gray-300">
          ...
          <tfoot>
            <tr class="bg-gray-200 font-semibold border-t-2 border-black">
              ...
              <td class="text-center p-2 border-r border-black">
                {itemLines.reduce((sum, line) => sum + line.qty, 0).toFixed(2)}
              </td>
        ...
        <table class="w-full mb-4 border border-black text-xs">
          <thead>
            ...
            <tr class="bg-gray-200 border-t border-black">
              ...
              <th class="text-center p-1 border-r border-black text-xs">Amt</th>
              <th class="text-center p-1 border-r border-black text-xs">%</th>
              <th class="text-center p-1 border-r border-black text-xs">Amt</th>
            </tr>
          </thead>
          <tbody>
            {#each calculateGSTBreakdown() as gst}
              <tr class="border-t border-gray-300">
                ...
                >
                <td class="text-right p-2">{formatCurrency(gst.totalAmount)}</td
                >
              </tr>
            {/each}
            <tr class="bg-gray-200 font-semibold border-t-2 border-black">
      ...
      <div class="grid grid-cols-2 gap-6 mb-4 border-t border-black pt-4">
        ...
        <div class="text-xs">
          {#if config?.termsAndConditions}
            ...
            <div class="whitespace-pre-line">{config?.termsAndConditions}</div>
          {/if}
        ...
        <div class="text-sm">
          ...
          <div class="grid grid-cols-2 gap-4 mt-16">
            <div class="text-left">
              <div class="border-t border-black pt-1">Receiver's Signature</div>
            </div>
            <div class="text-right">
